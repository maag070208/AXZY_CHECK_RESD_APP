...
export type RootStackParamList = {
  ...
  // === NEW ADMIN MODULES ===
  RESIDENTS_STACK: {
    RESIDENTS_LIST: ScreenParams;
    RESIDENT_DETAIL: ScreenParams<{ residentId: string }>;
    RESIDENT_FORM: ScreenParams<{ residentId?: string }>;
  };
  PROPERTIES_STACK: {
    PROPERTIES_LIST: ScreenParams;
    PROPERTY_FORM: ScreenParams<{ propertyId?: string }>;
  };
  ACCESSES_STACK: {
    ACCESSES_LIST: ScreenParams;
    ACCESS_QR_SCAN: ScreenParams;
  };
  COMPLAINTS_STACK: {
    COMPLAINTS_LIST: ScreenParams;
    COMPLAINT_FORM: ScreenParams;
    COMPLAINT_DETAIL: ScreenParams<{ complaintId: string }>;
  };
  PAYMENTS_STACK: {
    PAYMENTS_LIST: ScreenParams;
    PAYMENT_DETAIL: ScreenParams<{ paymentId: string; sessionId?: string }>;
    PAYMENT_RECEIPT: ScreenParams<{ paymentId: string; sessionId?: string }>;
  };
  FEES_STACK: {
    FEES_LIST: ScreenParams;
    FEE_FORM: ScreenParams<{ feeId?: string }>;
  };
  REPORTS_STACK: {
    REPORTS_LIST: ScreenParams;
  };
  SETTINGS_STACK: {
    SETTINGS_LIST: ScreenParams;
  };
  CONTACTS_STACK: {
    CONTACTS_LIST: ScreenParams;
  };
};
