...
interface ResidencialFormStepperProps {
  values: any;
...
export const ResidencialFormStepper = ({
  values,
  errors,
  touched,
  handleChange,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.formContent}>
        ...
        {currentStep === 0 && (
          <View style={styles.stepContainer}>
            <ITInput
              label="Nombre de la Residencial"
            ...
            <View style={styles.infoBox}>
              ...
              <ITText variant="labelSmall" style={styles.infoBoxText}>
                {isEdit
                  ...
                  : 'Configura las credenciales para que la residencial pueda acceder a la aplicación.'}
              </ITText>
            </View>
      ...
      <ITAlert
        ...
        description="No se recomienda cambiar el nombre de usuario de una residencial ya registrada. ¿Deseas continuar?"
        type="warning"
