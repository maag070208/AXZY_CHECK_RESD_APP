...
interface ResidencialZoneFormModalProps {
  visible: boolean;
  onDismiss: () => void;
  onSuccess: () => void;
...
export const ResidencialZoneFormModal = ({
  visible,
  onDismiss,
  onSuccess,
  residencialId,
      ...
      >
        ...
        >
          <ITText variant="bodyMedium" style={styles.subtitle}>
            Define las zonas operativas para esta residencial para organizar mejor
