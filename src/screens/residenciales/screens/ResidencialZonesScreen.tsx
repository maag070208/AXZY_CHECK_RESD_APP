...
import { ResidencialZoneFormModal } from '../modal/ResidencialZoneFormModal';
import { ResidencialStackParamList } from '../stack/ResidencialStack';

type ClientZonesRouteProp = RouteProp<ResidencialStackParamList, 'CLIENT_ZONES'>;

export const ResidencialZonesScreen = () => {
  const route = useRoute<ClientZonesRouteProp>();
  const navigation = useNavigation<any>();
  const { clientId: residencialId } = route.params;
  ...
  const fetchZones = async (isRefresh = false, isLoadMore = false) => {
    ...
    try {
      ...
      const filters: any = { clientId: residencialId };
