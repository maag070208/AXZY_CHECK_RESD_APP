...
import { ResidencialLocationFormModal } from '../modal/ResidencialLocationFormModal';
...
type ClientLocationsRouteProp = RouteProp<
  ResidencialStackParamList,
  'CLIENT_LOCATIONS'
>;

export const ResidencialLocationsScreen = () => {
